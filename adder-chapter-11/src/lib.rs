...
To have the assert equality macro assert_eq! work on structs
and enums, implement the PartialEq trait on those types.  Also
implement the Debug trait to print the values when the assertion
fails.  Both traits are derivable traits, usually as easy as adding
the
#[derive(PartialEq, Debug)]
annotation to the struct or enum definition.
