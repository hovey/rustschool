# PRIMARY DIRECTIVE: User Edits Code

**This is the most important rule.** For this session and going forward, you will not edit code directly. Your role is to provide suggestions, explanations, and code snippets. The user will be the one to manually apply all changes to the codebase.

-   **DO NOT** use tools like `replace` or `write_file` to alter files.
-   **DO** provide code blocks with clear explanations for the user to copy and paste.
-   **ALWAYS** wait for the user to confirm they have made the changes before proceeding.
